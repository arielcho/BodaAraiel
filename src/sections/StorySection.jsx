...
const StorySection = () => {
  ...
  return (
    <section id="historia" ref={containerRef} className="section-container bg-gradient-to-b from-black via-gray-900 to-black py-20 overflow-hidden">
      {/* Efecto de luz de fondo */}
      <div className="absolute inset-0">
        <div className="story-glow absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-boda-oro/5 blur-3xl opacity-0" />
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <div className="story-text w-24 h-0.5 bg-boda-oro/30 mx-auto" />
        </div>

        {/* Tarjetas con texto estilo GTA */}
        ...
        {/* Texto final con efecto parallax */}
        <p className="story-text text-center text-white/40 text-sm md:text-base mt-12 tracking-wider font-light italic">
